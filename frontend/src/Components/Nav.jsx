...
function Nav({ show ,toggle }) {
    ...
    const inactiveIcon = "w-6 h-6 " + " text-white";
        ...
        <aside className={(show ? " left-0 " : " -left-full ") + 'top-0 p-4 fixed w-full h-full md:static md:w-auto transition-all gap-2 flex bg-[#A4907C] flex-col'}>
            ...
            <nav className='flex flex-col gap-2'>
                ...
                {/* <Link to={'/categories'} className={pathname.includes('/categories') ? activeLink : inactiveLink}>
                    <svg className={pathname.includes('/categories') ? activeIcon : inactiveIcon} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                ...
                <Link to={'/orders'} className={pathname.includes('/orders') ? activeLink : inactiveLink}>
                    <svg className={pathname.includes('/orders') ? activeIcon : inactiveIcon} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 010 3.75H5.625a1.875 1.875 0 010-3.75z" />
                    </svg>
                    Orders
                </Link> */}
                {/* <Link to={'/admins'} className={pathname.includes('/admins') ? activeLink : inactiveLink}>
                    <svg className={pathname.includes('/admins') ? activeIcon : inactiveIcon} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
